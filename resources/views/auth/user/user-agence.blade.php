...
@if(Auth::user()->role == 'Concepteur' or Auth::user()->role == 'Administrateur')
 ...
 <table id="table" class="table table-warning table-striped box box-primary"
                           ...
                           data-url="{{url('auth', ['action'=>'liste-users-agences'])}}"
        ...
        <thead>
           <tr>
            ...
            <th data-field="agence.libelle_agence" data-searchable="true">Agence</th>
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    ...
                    <span style="font-size: 16px;">
                        ...
                        Gestion des utilisateurs agence
                    </span>
                </div>
                        ...
                        <div class="col-md-6" id="row_depot">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="agence_id" id="agence_id" ng-model="user.agence_id" class="form-control">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" ng-model="user.email" id="email" name="email" placeholder="Adresse mail de l'utilisateur" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
...
<script type="text/javascript">
    ...
    appSmarty.controller('formPasswordResetCtrl', function ($scope) {
     ...
     $(function () {
        ...
        $("#formAjout").submit(function (e) {
            ...
            if (ajout === true) {
            var methode = 'POST';
            var url = "{{route('auth.add-user-agence')}}";
            } else {
            var id = $("#idUserModifier").val();
            var methode = 'PUT';
            var url = 'update-user-agence/' + id;
            }
            editerUserAgenceAction(methode, url, $(this), $(this).serialize(), $ajaxLoader, $table, ajout);
        });
    ...
    function updateRow(idUser) {
       ...
       $('#agence_id').select2("val", user.agence_id); 
 ...
 function editerUserAgenceAction(methode, url, $formObject, formData, $ajoutLoader, $table, ajout = true) {
    jQuery.ajax({
        type: methode,
        url: url,
        cache: false,
