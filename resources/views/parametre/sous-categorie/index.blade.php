    ...
    <div class="row">
        ...
        <div class="col-md-12" style="margin-bottom: 10px">
            <h1>
                ...
                <a href="{{route('parametre.sous_categorie.dowload_model')}}" role="button" class="btn btn-sm btn-secondary pull-right" style="background:#F9F9F9">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
                <input type="text" name="id" ng-model="sousCategorie.id" ng-hide="true" class="hidden">
                @csrf
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.substr(1);" id="libelle_categorie" name="libelle_categorie" ng-model="sousCategorie.libelle_categorie" class="form-control" placeholder="Libellé du sous catégorie" required>
                        </div>
                        <div class="form-group">
        ...
        <form id="formSupprimer" ng-controller="formSupprimerCtrl" action="#">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <div class="clearfix">
                        <div class="text-center question"><i class="fa fa-question-circle fa-2x"></i> Etes vous certains de vouloir supprimer le sous cat&eacute;gorie <br/><b>@{{sousCategorie.libelle_categorie}}</b></div>
...
<x-modal-creation-en-masse action="{{route('parametre.sous_categorie.store_from_upload')}}"/>
