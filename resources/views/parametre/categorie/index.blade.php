...
<div class="row">
    ...
    <div class="col-md-12" style="margin-bottom: 10px">
        <h1>
            ...
            <a href="{{route('modele.download', 'modele-importation-en-masse-catégorie.xlsx')}}" role="button" class="btn btn-sm btn-secondary pull-right" style="background:#F9F9F9">
...
<x-modal-creation-en-masse action="{{route('parametre.categorie.store_from_upload')}}"/>
