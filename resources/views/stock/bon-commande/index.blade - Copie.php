...
<table id="table" class="table table-warning table-striped box box-primary"
    ...
    <thead>
        <tr>
            ...
            <th data-formatter="optionFormatter" data-width="80px" data-align="center"><i class="fa fa-wrench"></i></th>
        </tr>
    </thead>
</table>
                ...
                <div class="modal-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                                <label>
                                    <input type="radio" checked="checked" value="fournisseur" id="fournisseur" name="type"/>&nbsp;&nbsp;Fournisseur
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
                                <label>
                                    <input type="radio" value="client" id="client" name="type"/>&nbsp;&nbsp; Client
                                </label>
                            </div>
                        </div>
                        <div class="col-md-2"></div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="fournisseur_id" id="fournisseur_id" ng-model="bonCommande.fournisseur_id" ng-init="bonCommande.fournisseur_id=''" class="form-control select2">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="client_id" id="client_id" ng-model="bonCommande.client_id" ng-init="bonCommande.fournisseur_id=''" class="form-control select2">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#fournisseur_id, #client_id, #article, #article_add, #searchByFournisseur,#searchByClient").select2({width: '100%'});
        ...
        $("#searchByClient").change(function (e) {
            ...
            if(client == 0){
              ...
              $table.bootstrapTable('refreshOptions', {url: '../stock/liste-bon-commandes-by-client/' + client});
            }
        });
        ...
        $("#article_add").change(function (e) {
            var name_article = $("#article_add").children(":selected").data("libellearticle");
            $.getJSON("../stock/get-article-by-id/" + article_id, function (reponse) {
                if(reponse.total>0){
                    $.each(reponse.rows, function (index, article) {
    ...
    function updateRow(idBonCommande) {
        ...
        $tableArticle.bootstrapTable('refreshOptions', {url: "../boutique/liste-articles-bon/" + idBonCommande});
    ...
    function optionFormatter(id, row) {
        if(row.etat==2){
            return '<span class="text-bold text-green">Bon validé</span>';
        }else{
